...
<div>
    ...
    <main>
        {#if $user}
            ...
            <button class="btn btn-base mt-5 hover:btn-warning"on:click={()=> signOut(auth)}>Cerrar sesion</button>
            <a href="login/username">
                <button class="btn btn-primary mt-5 hover:btn-accent">Continuar ></button>
            </a>
        {:else}
